...
HTML;
                ...
                if ($this->params->def('addfacebook')) {
		 		$scriptPage .= <<<HTML
					<a title="Розповісти друзям на $titlefc" href="$article_url" class="like l-fb">
					<i class="l-ico"></i>
...
HTML;
			...
			if ($this->params->def('addvk')) {
				$scriptPage .= <<<HTML
					<a title="Розповісти друзям $titlevk" href="$article_url" class="like l-vk">
					<i class="l-ico"></i>
					<span class="l-count"></span>
					</a>
HTML;
			...
			if ($this->params->def('addtw')) {
				$scriptPage .= <<<HTML
					<a title="Розповісти друзям в $titletw" href="$article_url" class="like l-tw">
					<i class="l-ico"></i>
					<span class="l-count"></span>
					</a>
HTML;
			...
			if ($this->params->def('addod')) {		
				$scriptPage .= <<<HTML
					<a title="Розповісти друзям в $titleod" href="$article_url" class="like l-ok">
					<i class="l-ico"></i>
					<span class="l-count"></span>
					</a>
HTML;
			...
			if ($this->params->def('addgp')) {
				$scriptPage .= <<<HTML
					<a title="Розповісти друзям в $titlegg" href="$article_url" class="like l-gp">
					<i class="l-ico"></i>
					<span class="l-count"></span>
					</a>
HTML;
				...
				<div style="text-align: left;">
					<a style="text-decoration:none; color: #020EBA; font-family: arial,helvetica,sans-serif; font-size: 10pt; href="#">Поділитися з друзями</a>
				</div>
