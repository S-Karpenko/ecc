...
class MijosefModelSefUrlsDp extends MijosefModel {
	...
	function getToolbarSelections() {
        ...
        $toolbar->selection = JHTML::_('select.genericlist', $sel, 'sefurlsdp_selection', 'class="inputbox" style="margin-top: 17px;" size="1"');
		
		// Button
        $toolbar->button = '<button style="margin-top: 17px;" onclick="apply();" />'.JText::_('Apply').'</button>';
