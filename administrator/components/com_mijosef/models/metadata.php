...
class MijosefModelMetadata extends MijosefModel {
	...
	function getToolbarSelections() {
        ...
        $toolbar->action = JHTML::_('select.genericlist', $act, 'meta_action', 'class="inputbox" style="margin-top: 17px;" size="1" onchange="showInput();"');
		...
		$toolbar->fields = '<div id="meta_fields" style="display: none">'.JHTML::_('select.genericlist', $fields, 'tb_newfields', 'class="inputbox" style="margin-top: 17px;" size="1"', 'value', 'text', 'all').'</div>';
        ...
        $toolbar->selection = JHTML::_('select.genericlist', $sel, 'meta_selection', 'class="inputbox" style="margin-top: 17px;" size="1"');
