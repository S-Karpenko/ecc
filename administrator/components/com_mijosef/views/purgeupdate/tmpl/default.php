...
?>
<form action="index.php?option=com_mijosef&amp;controller=purgeupdate&amp;task=view&amp;tmpl=component" name="adminForm" method="post">
	<table class="noshow">
		<tr>
			<td width="50%">
				<fieldset>
					...
					<?php if ($this->urls['total'] != 0) { ?>
						...
						<input type="submit" class="button" name="updateurls" value="<?php echo JText::_('COM_MIJOSEF_TOOLBAR_UPDATE'); ?>" />
					<?php } ?>
				</fieldset>
			</td>
			<td width="50%">
				<fieldset height="350">
					...
					<?php if ($this->meta['total'] != 0) { ?>
						...
						<input type="submit" class="button" name="updatemeta" value="<?php echo JText::_('COM_MIJOSEF_TOOLBAR_UPDATE'); ?>" />
					<?php } ?>
				</fieldset>
			</td>
		</tr>
