    ...
    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_COMMON_URL'), 'url'); ?>
		<table class="admintable">
			...
			<tr>
				...
				<td width="77%">
					<textarea name="url_notes" rows="3" cols="57" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars($this->url['notes'], true); ?></textarea>
				</td>
			</tr>
		</table>
    ...
    <?php echo JHtml::_('tabs.panel', JText::_('COM_MIJOSEF_COMMON_METADATA'), 'meta'); ?>
		<table class="admintable">
			...
			<tr>
				...
				<td width="77%">
					<input class="inputbox" type="text" name="meta_title" size="80" value="<?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->title), true); ?>" />
			...
			<tr>
				...
				<td width="77%">
					<textarea name="meta_desc" rows="5" cols="57" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->description), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
				...
				<td width="77%">
					<textarea name="meta_key" rows="3" cols="57" class="text_area"><?php echo Mijosef::get('utility')->replaceSpecialChars(htmlspecialchars($this->metadata->keywords), true); ?></textarea>
				</td>
			</tr>
			<tr>
				<td width="23%" class="key2">
