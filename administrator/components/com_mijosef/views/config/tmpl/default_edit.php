...
* @package		MijoSEF
* @subpackage	MijoSEF
* @copyright	Copyright (C) 2009 www.mijosoft.com
...
<form action="index.php" method="post" name="adminForm">
    ...
    <?php echo JHtml::_('tabs.start', 'configuration'); ?>
				...
				<fieldset class="adminform">
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								<td class="key2">
									<span class="hasTip" title="<?php echo JText::_('COM_MIJOSEF_CONFIG_MAIN_JQUERY'); ?>::<?php echo JText::_('COM_MIJOSEF_CONFIG_MAIN_JQUERY_HELP'); ?>">
										<?php echo JText::_('COM_MIJOSEF_CONFIG_MAIN_JQUERY'); ?>
									</span>
								</td>
								<td>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									&nbsp;
									<input type="text" name="cache_urls_size" id="cache_urls_size" class="inputbox" size="10" value="<?php echo $this->MijosefConfig->cache_urls_size; ?>" />
								</td>
							</tr>
							<tr>
								<td class="key2">
				...
				<table class="admintable">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" name="url_suffix" id="url_suffix" class="inputbox" size="10" value="<?php echo $this->MijosefConfig->url_suffix; ?>" />
							</td>
						</tr>
						<tr>
							<td class="key2">
							...
							<td>
								<input type="text" name="replacement_character" id="replacement_character" class="inputbox" size="10" value="<?php echo $this->MijosefConfig->replacement_character; ?>" />
							</td>
						</tr>
						<tr>
							<td class="key2">
				...
				<fieldset class="adminform">
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								<td class="key2">
									<span class="hasTip" title="<?php echo JText::_('COM_MIJOSEF_CONFIG_URL_JF_MAINLANG_VAR'); ?>::<?php echo JText::_('COM_MIJOSEF_CONFIG_URL_JF_MAINLANG_VAR_HELP'); ?>">
										<?php echo JText::_('COM_MIJOSEF_CONFIG_URL_JF_MAINLANG_VAR'); ?>
									</span>
								</td>
								<td>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<textarea name="char_replacements" cols="40" rows="8"><?php echo $this->MijosefConfig->char_replacements; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							<tr>
								...
								<td>
									<textarea name="non_sef_vars" id="non_sef_vars" cols="40" rows="3"><?php echo $this->MijosefConfig->non_sef_vars; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="disable_sef_vars" id="disable_sef_vars" cols="40" rows="3"><?php echo $this->MijosefConfig->disable_sef_vars; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="skip_menu_vars" id="skip_menu_vars" cols="40" rows="3"><?php echo $this->MijosefConfig->skip_menu_vars; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									&nbsp;
									<input type="text" name="meta_name_1" id="meta_name_1" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_name_1; ?>">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php echo JText::_('COM_MIJOSEF_CONFIG_META_CONTENT'); ?>
									&nbsp;&nbsp;
									<input type="text" name="meta_con_1" id="meta_con_1" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_con_1; ?>">
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									...
									<?php echo JText::_('COM_MIJOSEF_CONFIG_META_NAME'); ?>
									&nbsp;
									<input type="text" name="meta_name_2" id="meta_name_2" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_name_2; ?>">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php echo JText::_('COM_MIJOSEF_CONFIG_META_CONTENT'); ?>
									&nbsp;&nbsp;
									<input type="text" name="meta_con_2" id="meta_con_2" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_con_2; ?>">
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									...
									<?php echo JText::_('COM_MIJOSEF_CONFIG_META_NAME'); ?>
									&nbsp;
									<input type="text" name="meta_name_3" id="meta_name_3" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_name_3; ?>">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php echo JText::_('COM_MIJOSEF_CONFIG_META_CONTENT'); ?>
									&nbsp;&nbsp;
									<input type="text" name="meta_con_3" id="meta_con_3" class="inputbox" size="18" value="<?php echo $this->MijosefConfig->meta_con_3; ?>">
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="meta_t_seperator" id="meta_t_seperator" class="inputbox" size="5" value="<?php echo $this->MijosefConfig->meta_t_seperator; ?>">
								</td>
							</tr>
							<tr>
								<td class="key2">
					...
					<table class="admintable">
						<tbody>
							<tr>
								...
								<td>
									<textarea name="meta_key_blacklist" cols="40" rows="6"><?php echo $this->MijosefConfig->meta_key_blacklist; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="meta_key_whitelist" cols="40" rows="4"><?php echo $this->MijosefConfig->meta_key_whitelist; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="sm_file" id="sm_file" class="inputbox" size="30" value="<?php echo $this->MijosefConfig->sm_file; ?>" /> .xml
									<?php
										if(file_exists(JPATH_SITE.DS.$this->MijosefConfig->sm_file.'.xml')){
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<textarea name="sm_ping_services" cols="40" rows="5"><?php echo $this->MijosefConfig->sm_ping_services; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<textarea name="sm_auto_filter_s" cols="40" rows="3"><?php echo $this->MijosefConfig->sm_auto_filter_s; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="sm_auto_filter_r" cols="40" rows="3"><?php echo $this->MijosefConfig->sm_auto_filter_r; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="tags_in_page" id="tags_in_page" class="inputbox" size="20" value="<?php echo $this->MijosefConfig->tags_in_page; ?>" />
								</td>
							</tr>
							<tr>
								<td class="key2">
					...
					<table class="admintable">
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="tags_limit" id="tags_limit" class="inputbox" size="20" value="<?php echo $this->MijosefConfig->tags_limit; ?>" />
								</td>
							</tr>
							<tr>
								<td class="key2">
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="tags_auto_length" id="tags_auto_length" class="inputbox" size="5" value="<?php echo $this->MijosefConfig->tags_auto_length; ?>" />
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="tags_auto_filter_s" cols="40" rows="3"><?php echo $this->MijosefConfig->tags_auto_filter_s; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="tags_auto_filter_r" cols="40" rows="3"><?php echo $this->MijosefConfig->tags_auto_filter_r; ?></textarea>
								</td>
							</tr>
							<tr>
								<td class="key2">
								...
								<td>
									<textarea name="tags_auto_blacklist" cols="40" rows="5"><?php echo $this->MijosefConfig->tags_auto_blacklist; ?></textarea>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="ilinks_limit" id="ilinks_limit" class="inputbox" size="3" value="<?php echo $this->MijosefConfig->ilinks_limit; ?>" />
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="admintable">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="bookmarks_icons_line" id="bookmarks_icons_line" class="inputbox" size="3" value="<?php echo $this->MijosefConfig->bookmarks_icons_line; ?>" />
								</td>
							</tr>
						</tbody>
					</table>
