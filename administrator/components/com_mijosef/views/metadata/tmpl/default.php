...
<form action="index.php?option=com_mijosef&amp;controller=metadata&amp;task=view" method="post" name="adminForm" id="adminForm">
	<dl class="tabs">
	    <dt onclick="javascript: changeType('all');" class="<?php echo ($this->type == 'all') ? 'open' : 'closed'; ?>" style="cursor: pointer"><b><?php echo JText::_('COM_MIJOSEF_METADATA_TABS_ALL'); ?></b></dt>
	    <dt onclick="javascript: changeType('dtitle');" class="<?php echo ($this->type == 'dtitle') ? 'open' : 'closed'; ?>" style="cursor: pointer"><b><?php echo JText::_('COM_MIJOSEF_METADATA_TABS_DTITLE'); ?></b></dt>
	    <dt onclick="javascript: changeType('ddesc');" class="<?php echo ($this->type == 'ddesc') ? 'open' : 'closed'; ?>" style="cursor: pointer"><b><?php echo JText::_('COM_MIJOSEF_METADATA_TABS_DDESC'); ?></b></dt>
	</dl>
	<div class="current">
